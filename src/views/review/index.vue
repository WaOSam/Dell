...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="currentState" label="当前状态" width="180" />
      <el-table-column prop="runTime" label="运行时长" width="180" />
      <el-table-column prop="stopTime" label="停运时间" width="180" />
    </el-table-pageable>
  </div>
...
<script>
import { XlTablePageable } from 'el-views'
