<template>
  <div class="app-container">
    ...
    >
      ...
      <el-col :span="4" :push="1"> 维修订单号: </el-col>
    ...
    >
      ...
      <el-table-column prop="producttype" label="维修订单号" align="center">
      </el-table-column>
      <el-table-column prop="alteredcolumn" label="购买订单号" align="center">
      </el-table-column>
      <el-table-column prop="altertype" label="维修理由描述" align="center">
      </el-table-column>
      <el-table-column prop="alteredreason" label="维修申请时间" align="center">
      </el-table-column>
      <el-table-column prop="alteredcontent" label="当前状态" align="center">
      </el-table-column>
