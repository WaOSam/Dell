      ...
      <el-row :gutter="11">
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">今日维修订单</div>
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">今日销售订单</div>
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">昨日销售订单</div>
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">待处理维修订单</span>
              <span style="float: right" class="color-danger">(4)</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">待确认进货单</span>
              <span style="float: right" class="color-danger">(15)</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">待保养订单</span>
