<template>
  <div class="app-container">
    ...
    >
      ...
      <el-col :span="4" :push="4"> 车辆ID: </el-col>
      <el-col :span="2">
    ...
    >
      ...
      <el-table-column prop="producttype" label="购买订单编号" align="center">
      </el-table-column>
      <el-table-column prop="alteredcolumn" label="车辆ID" align="center">
      </el-table-column>
      <el-table-column prop="altertype" label="车辆信息" align="center">
      </el-table-column>
      <el-table-column prop="alteredreason" label="购买时间" align="center">
      </el-table-column>
      <el-table-column
        prop="alteredcontent"
        label="上次保养时间"
